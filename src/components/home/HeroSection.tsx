    ...
    return (
        <section className="flex items-center flex-col md:flex-row justify-between gap-1 md:gap-10 w-full">
            ...
            <div className="flex flex-col items-center md:items-start gap-10 md:gap-16 md:w-1/2 w-full">
                ...
                <div className="w-full flex items-center gap-4 px-4 md:px-0">

                    <button type="button" className="w-full whitespace-nowrap md:w-fit px-6 py-3 rounded-md gradient-btn text-white text-[15px] font-semibold tracking-wide shadow-[0_3px_6px] shadow-[#EC4899]/50 transition-all hover:shadow-none cursor-pointer">Explore Technologies</button>

                    <button type="button" className="w-full whitespace-nowrap md:w-fit px-6 py-3 rounded-md border border-border bg-white text-foreground text-[15px] font-semibold tracking-wide transition-all hover:text-primary hover:border-primary cursor-pointer shadow">Learn More</button>
